...
//  비트 연산자 : &(and) , |(or) , ~(complement , not) , ^(xor) , >>(right shift) , <<(left shift) >>>(right shift)
public class Operation7 {
	public static void main(String[] args) {
		...
		System.out.println("x ^ y: "+Integer.toBinaryString(x ^ y)); // xor 입력이 서로 다를때 1 같을때 0
		...
		i = 25;
		i |= j; // i = i | j
		System.out.println("i or = j: " + i); // 1 1 1 1 1 1 => 31
		i = 25;
		i ^= j; // i = i ^ j
		System.out.println("i ^= j: " +i); // 1 0 0 1 1 1 => 7 
